...
#ifndef SAN9PK_WIN10_VERSION_FUNC_HOOKER_H_
#define SAN9PK_WIN10_VERSION_FUNC_HOOKER_H_
...
class func_hooker final {
 public:
  ...
  bool install(void *func_ptr, void *hook_ptr);
...
#endif  // SAN9PK_WIN10_VERSION_FUNC_HOOKER_H_
